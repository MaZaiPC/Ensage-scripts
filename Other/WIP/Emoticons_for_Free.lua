--<<Download texture https://mega.co.nz/#!uBFkQSxB!bCMM30B0NUw2YMZtqzc9UdMq51mbPlg3aJMssU1ZC70 and unpack to nyanUI/other>>
...
rec[27] = drawMgr:CreateRect(225*rate,80*rate,20*rate,20*rate,0x000000FF,drawMgr:GetTextureId("NyanUI/miniheroes/bristleback"))
                         ...
                         if msg == LBUTTON_DOWN then -- Left mouse
                          if activate then
                           ...
                           elseif IsMouseOn(rec[19]) then
                            client:ExecuteCmd(sayTo.."") --antimage
                           ...
                           elseif IsMouseOn(rec[39]) then
                            client:ExecuteCmd(sayTo.."") --bounty
